...
<div class="absolute inset-0 z-[-1]">
	<img src="/red-bull.avif" alt="Background" class="w-full h-full object-cover blur-xs brightness-75" />
</div>
<div class="flex flex-col items-center justify-center h-[calc(100vh-5rem)] text-white gap-8">
	<!-- Heading -->
